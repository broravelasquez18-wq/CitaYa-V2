...
function setup() {
 ...
 form.querySelector=()=>null; form.action='http://localhost/?page=admin';
 ...
 class XHR {constructor(){this.events={};this.upload=element();requests.push(this);}addEventListener(k,f){this.events[k]=f;}open(){}setRequestHeader(k,v){this.accept=v;}send(v){this.data=v;}}
